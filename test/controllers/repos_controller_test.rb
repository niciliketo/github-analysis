...
class ReposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repo" do
    assert_difference('Repo.count') do
      post repos_url, params: { repo: { full_name: @repo.full_name, data: @repo.data, public: @repo.public, user_id: @repo.user_id } }
    end
  ...
  test "should update repo" do
    patch repo_url(@repo), params: { repo: { full_name: @repo.full_name, data: @repo.data, public: @repo.public, user_id: @repo.user_id } }
